...
Sea $k$ una fracción de la unidad, $0 < k < 1$ , y $f$ otra tal que $f = 1 – k$ entonces podemos dividir el error anterior en sus dos componentes, por una parte

\begin{equation}
    k \cdot E_c = \frac{E_{\Delta x}}{\Delta t} \implies E_{\Delta x} = k \cdot E_c \cdot \Delta t
\end{equation}
...
\begin{align}
    E_{\Delta x} &\sim k \cdot 2 \times 10^{-7} \text{ m} \\
