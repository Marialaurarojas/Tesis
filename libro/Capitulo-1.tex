...
Esta expresión es a lo que nos referiremos de ahora en adelante como \ac{HCC}, y será el objeto central de este estudio.
...
\begin{figure}[hbt]
\centering
\includegraphics[scale=0.75]{Curva c_i vs g_i.png}
...
\begin{figure}[hbt]
\begin{center}
\includegraphics[scale=0.75]{curva c_i vs g_i zoom.png}
...
\hline
\end{tabular}
\caption{Valores de gravedad y velocidad de la luz esperada en diferentes localidades}
