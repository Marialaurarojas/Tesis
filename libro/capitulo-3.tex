...
\end{equation}
Con $A_c$ siendo el área de las placas y $d$ la separación entre ellas. En cualquier capacitor se cumple que su capacitancia depende de su geometría y del material, con ecuaciones análogas a \ref{fig:curvaPlana} en cada caso. Entonces, medir la capacitancia de un capacitor permite conocer el valor de $\epsilon_0$ que es equivalente a medir la velocidad de la luz. 
...
\begin{figure}[h!]\centering\includegraphics[width=0.85\linewidth]{Simulacion-respuesta1.png.png}\caption{Curvas $I(f)$ para las tres locaciones.}\end{figure}
...
\begin{figure}[h!]\centering\includegraphics[width=0.85\linewidth]{Simulacion-respuesta2.png}\caption{Detalle de la curva $I(f)$.}\end{figure}
