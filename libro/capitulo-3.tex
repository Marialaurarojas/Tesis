...
\begin{figure}[h!]\centering\includegraphics[width=0.7\linewidth]{Simulacion-respuesta1.png}\caption{Curvas $I(f)$ para las tres locaciones.}\end{figure}
...
\begin{figure}[h!]\centering\includegraphics[width=0.7\linewidth]{Simulacion-respuesta2.png}\caption{Detalle de la curva $I(f)$.}\end{figure}
