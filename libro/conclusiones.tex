...
Se realizaron dos experimentos para medir los efectos de la densidad de energía gravitacional sobre la velocidad de la luz, uno directo y otro indrecto. El experimento de medición directa de c usando un láser fue notoriamente insuficiente para la tarea de verificar la \ac{HCC} pues la velocidad de la luz se obtuvo con una precisión de 1\% en el mejor de los casos, por lo que ese enfoque con los equipos que se cuentan en el laboratorio es erroneo. Por otro lado el experimento II demostro ser una metodología más prometedora para aproximarse a la resolución infinitesimal que se exige en esta misión. 
...
A su vez el experimento II, al ser un circuito resonante RLC permitió el desarrollo de dos configuraciones distintas, una en paralelo y otra en serie. En terminos de dispersión y ajuste los mejores resultados de barrido se dieron con la conexión en paralelo, cuyo error relativo relativo de la frecuencia de resonancia se ubicó en un mínimo de 0.0036\%, mientras que la conexión en serie desmejoró notablemente alcanzando un error del 0.34\%, dos órdenes de magnitud por encima. 
